...
\usepackage{times}	%set font type
\usepackage{textcomp,wasysym,comment,titlesec,color,booktabs} %colortbl,
\usepackage{nomencl}	%package for using nomenclature throughout document
...
\usepackage{url}
\usepackage{float}
\usepackage{pdfpages}	%for including pdf in document
...
%sets up path for figures files
